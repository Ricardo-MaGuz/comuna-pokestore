                  ...
                  <ListItemText
                    ...
                    secondary={
                      <Typography variant="body2" color="text.secondary">
                        {formatPrice(item.pokemon.price, item.pokemon.currency)} cada uno
                      </Typography>
                    }
                  />
                  <ListItemSecondaryAction>
      ...
      <Dialog open={showCheckoutDialog} onClose={() => setShowCheckoutDialog(false)}>
        ...
        <DialogContent>
          <Typography variant="body1" gutterBottom>
            ¿Estás seguro de que quieres comprar estos Pokémon por {formatPrice(totalInWalletCurrency, wallet.currency)}?
          </Typography>
          <Typography variant="body2" color="text.secondary">
            Tu saldo después de la compra será: {formatPrice(wallet.balance - totalInWalletCurrency, wallet.currency)}
          </Typography>
        </DialogContent>
        <DialogActions>
